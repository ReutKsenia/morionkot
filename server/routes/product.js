...
router.post('/add-product', (req, res) => {
  Product.create({name: req.body.name, image: req.body.image, price: req.body.price,
    weight: req.body.weight, description: req.body.description}, (err, product) => {
    if (err) {
      res.sendStatus(500)
    } else {
...
router.post('/change-product', (req, res) => {
  Product.updateOne({ _id: req.body._id }, {$set: {name: req.body.name, image: req.body.image, price: req.body.price,
    weight: req.body.weight, description: req.body.description}}, (err, product) => {
    if (err) {
      res.sendStatus(500)
    } else {
