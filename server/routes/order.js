...
router.post('/delete-order-for-manager', function (req, res, next) {
  passport.authenticate('managerStrategy', config.session, function (err, employee) {
    if (employee) {
...
router.post('/delete-order-for-courier', function (req, res, next) {
...
router.get('/orders-unexecuted-for-courier', function (req, res, next) {
  passport.authenticate('courierStrategy', config.session, function (err, employee) {
    if (employee) {
...
router.get('/orders-unexecuted-for-user', function (req, res, next) {
...
router.get('/orders-executed-for-user', function (req, res, next) {
  passport.authenticate('userStrategy', config.session, function (err, user) {
    if (user) {
      console.log(user);
...
router.post('/received-order', function (req, res, next) {
  passport.authenticate('userStrategy', config.session, function (err, user) {
    if (user) {
